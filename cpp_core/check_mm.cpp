...
Utilities generate_builtin_utilities() {
    ...
    utils[0] = {361, 1016, 1266, 4568, 5896, 6801, 6938, 6967, 7223, 9658};
    utils[1] = {745, 863, 1235, 1414, 2671, 3387, 4529, 5463, 5640, 7007};
    utils[2] = {496, 1906, 2071, 3924, 4455, 5458, 6195, 7262, 8941, 9444};
    utils[3] = {222, 227, 350, 682, 1181, 2049, 3706, 4403, 8731, 9315};
    return utils;
}
